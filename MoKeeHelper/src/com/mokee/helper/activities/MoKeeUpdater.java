...
public class MoKeeUpdater extends PreferenceFragment implements
    ...
    // add
    // intent extras
    public static final String EXTRA_UPDATE_LIST_UPDATED = "update_list_updated";// 更新
    ...
    private String getMoKeeVersionType() {
        ...
        if (MoKeeVersion.equals(getString(R.string.mokee_info_default))) {
            ...
            MoKeeVersionType = Utils.getMoKeeVersionTypeString(MoKeeVersion,
                    mContext);
        }
    ...
    private void refreshPreferences(LinkedList<UpdateInfo> updates) {
        ...
        for (UpdateInfo ui : updates) {
            ...
            if (isRomAll && !mPrefs.getBoolean(Constants.PREF_ROM_OTA, true)) {
                int itemDate = Integer
                        .valueOf(Utils.subBuildDate(ui.getName()));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mUpdateCheck) {
            ...
            if (value == Constants.UPDATE_TYPE_NIGHTLY
                    || value == Constants.UPDATE_TYPE_BETA
