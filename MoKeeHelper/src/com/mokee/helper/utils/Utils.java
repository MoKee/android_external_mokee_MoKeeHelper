...
public class Utils {
    ...
    public static String getMoKeeVersionTypeString(String version,
            Context context) {
        String MoKeeVersionType = version.substring(
                version.lastIndexOf("-") + 1, version.length()).toLowerCase();
